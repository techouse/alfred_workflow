...
extension $AlfredItemCopyWith on AlfredItem {
  /// Returns a callable class that can be used as follows: `instanceOfclass AlfredItem.name.copyWith(...)` or like so:`instanceOfclass AlfredItem.name.copyWith.fieldName(...)`.
