...
final class GithubReleaseFactory extends FixtureFactory<GithubRelease> {
  ...
  FixtureDefinition<GithubRelease> definition() => define((
    ...
    final int userId = faker.randomGenerator.integer(9999999, min: 1000000);
    final int releaseId = faker.randomGenerator.integer(9999999, min: 1000000);
    ...
    final DateTime createdAt = faker.date
        .dateTime(maxYear: _now.year, minYear: _now.year - 2)
        .toUtc();
    ...
    return GithubRelease(
      ...
      assets: GithubAssetFixture.factory
          .redefine(
            GithubAssetFixture.factory.withDetails(
              repoName: repoName,
              login: login,
              userId: userId,
              assetTag: tagName,
