...
void main() {
  ...
  group('toJson', () {
    ...
    test('exactOrder = true && skipKnowledge = true removes UIDs and includes skipknowledge', () {
    ...
    test('exactOrder = true && skipKnowledge = false removes UIDs and includes skipknowledge', () {
